...
#Summarize agent used to summarize the search results into reports
class SummarizeAgent():
    ...
    async def run(self,search_results:list[str])->str:
        #Summarize the search results into a report
...
class OrchestratorAgent:   
    ...
    async def search_node(self,state:ResearchState)->str:
